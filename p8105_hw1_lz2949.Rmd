...
char_vec = c(TRUE,TRUE,TRUE,TRUE,FALSE,TRUE,TRUE,FALSE,TRUE,FALSE)
...
Try to take the mean of each variable in the datafraome. 

1. The mean of random sample is: `r mean(random_sample)`. 

2. The mean of logical vector is: `r mean(logical_vec)`. 

3. The mean of character vector is: `r mean(char_vec)`. 

4. The mean of factor vector is: `r mean(vec_factor)`. 
